...
// q.Radius up to the maximum MinRadius any selected provider declares.
...
// extMockProvider is a mock provider with a custom searchFn for capturing query params.
