...
// TestSearch_AttachesWikiExtraSources confirms a listing's wikipedia= field
// surfaces the resolved article URL through the POI's ExtraSources, folded into
// EnrichedPoi.Sources by dedup without a phantom Wikipedia RawPoi.
...
// TestSearch_NestedTemplateDoesNotTruncateListing is a regression test: a
// listing whose directions= field nests a {{station|…}} template must not be
// truncated at the inner }}, which requires brace-depth-aware scanning.
