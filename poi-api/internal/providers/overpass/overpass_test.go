...
// TestSearch_ImagesFromOSMTags exercises image/image:url/wikimedia_commons tag
// handling: direct URLs kept, non-http dropped, Commons refs turned into
// FilePath URLs, duplicates removed and the result capped at 3.
